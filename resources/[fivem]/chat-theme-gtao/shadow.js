...
var blurFilter = document.createElementNS("https://www.w3.org/2000/svg", "filter");
blurFilter.setAttribute("id", "svgBlurFilter");
var feGaussianFilter = document.createElementNS("https://www.w3.org/2000/svg", "feGaussianBlur");
...
// Drop Shadow Filter
var dropShadowFilter = document.createElementNS("https://www.w3.org/2000/svg", "filter");
...
var feComposite = document.createElementNS("https://www.w3.org/2000/svg", "feComposite");
...
var feMerge = document.createElementNS("https://www.w3.org/2000/svg", "feMerge");
var feMergeNode = document.createElementNS("https://www.w3.org/2000/svg", "feMergeNode");
